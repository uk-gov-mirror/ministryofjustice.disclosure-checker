...
RSpec.feature "Caution - Adult (18 or over)", type: :feature do
  before do
    visit "/"
  ...
  scenario "Over 18, Simple caution" do
  ...
  scenario "Over 18, Conditional caution" do
    find("label", exact_text: "Conditional caution").click
    click_button "Continue"
    ...
    expect(page).to have_text("This caution will not appear on a basic DBS check.")
    expect(page).not_to have_text("Your results say your caution or conviction may appear on a DBS check.")
  end
end
