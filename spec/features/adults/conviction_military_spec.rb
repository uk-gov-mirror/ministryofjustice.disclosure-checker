...
RSpec.feature "Conviction - Military", type: :feature do
  ...
  [
    ...
    scenario "Adult military conviction with length - #{row[:subtype]}" do
  ...
  scenario "Adult military conviction without length - Dismissal" do
    start_military_conviction
    expect(page).to have_text("What was your military conviction?")
