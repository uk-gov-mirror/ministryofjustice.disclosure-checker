...
RSpec.feature "Conviction - Youth motoring", type: :feature do
  before do
    visit "/"
  ...
  [
    ...
    { length_months: "40", spent_date: "This conviction will be spent on 1 May 2023" },
  ].each do |row|
  ...
  [
    { endorsement: "Yes", spent_date: "This conviction will be spent on 1 July 2022" },
    { endorsement: "No",  spent_date: "This conviction was spent on 1 July 2020" },
  ].each do |row|
  ...
  scenario "Fixed Penalty notice (FPN) with endorsement" do
    travel_to Date.new(2020, 7, 3) do
      ...
      enter_date(1, 1, 2020)
      check_answers_and_go_to_results
      expect(page).to have_text("This conviction will be spent on 1 July 2022")
    end
  end
