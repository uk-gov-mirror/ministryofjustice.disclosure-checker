Feature: Conviction
  ...
  Examples:
    ...
    | Conditional discharge  | When were you given the discharge?  | Was the length of the conditions given in weeks, months or years?    | What was the length of the discharge?        | /steps/check/results |
