Feature: Conviction
  ...
  Examples:
    ...
    | Intoxicating substance treatment requirement                   | When were you given the treatment?             | Was the length of the treatment given in weeks, months or years?             | What was the length of the treatment?             | /steps/check/results |
    | Mental health treatment                                        | When were you given the treatment?             | Was the length of the treatment given in weeks, months or years?             | What was the length of the treatment?             | /steps/check/results |
    ...
    | Reparation order                                               | When were you given the order?                 | Was the length of the order given in weeks, months or years?                 | What was the length of the order?                 | /steps/check/results |
    ...
    | Supervision order on breach of a civil injunction              | When were you given the order?                 | Was the length of the order given in weeks, months or years?                 | What was the length of the order?                 | /steps/check/results |
